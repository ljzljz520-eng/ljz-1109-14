...
| Python | `python:3.12` | Python 应用 |
| Go | `golang:1.25-alpine` | Go 应用 |
| PostgreSQL | `postgres:18-alpine` | PostgreSQL 数据库 |
| Redis | `redis:7.0` | Redis 缓存 |
...
**Q: pip install 很慢？**  
A: 在安装时指定镜像源：`pip install --index-url https://pypi.tuna.tsinghua.edu.cn/simple packagename`
